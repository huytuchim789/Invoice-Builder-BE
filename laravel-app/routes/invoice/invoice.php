...
Route::post('/invoices/download', [InvoiceController::class, 'downloadFile'])->name('invoices.downloadFile');
...
Route::put('/invoices/{id}/mark-as-paid', [InvoiceController::class, 'maskAsPaid'])->name('invoices.markAsPaid');
